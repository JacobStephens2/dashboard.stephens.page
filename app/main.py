...
async def tools_private(request: Request):
    # The private tools page (private repo names + portfolio gaps) is generated by
    # infra/tools-refresh/generate.py into data/tools-private.html and served only
    # here. Access requires EITHER the dashboard session (passkey/password) OR, for
    # an authorized AI agent / automation, a bearer feed token. Never public.
